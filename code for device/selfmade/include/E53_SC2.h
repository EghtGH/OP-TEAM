...
#define WIFI_IOT_IO_FUNC_GPIO_0_I2C1_SDA 1
#define WIFI_IOT_IO_FUNC_GPIO_1_I2C1_SCL 1
...
#define WIFI_IOT_IO_NAME_GPIO_0 10//对应过来的SDA
#define WIFI_IOT_IO_NAME_GPIO_1 9//对应的SCL
